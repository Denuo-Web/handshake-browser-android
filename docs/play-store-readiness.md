...
| Android App Bundle | Ready | Signed upload AAB: `dist/play-store/hns-browser-v0.2.5-play-upload-signed.aab`. |
...
PLAY_TRACK=alpha \
  ...
  dist/play-store/hns-browser-v0.2.5-play-upload-signed.aab
```
